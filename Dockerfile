...
LABEL maintainer="ByteFreezer Team" \
      ...
      org.opencontainers.image.source="https://github.com/bytefreezer/receiver" \
      org.opencontainers.image.documentation="https://github.com/bytefreezer/receiver/blob/main/README.md" \
